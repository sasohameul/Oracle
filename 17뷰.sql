...
/*
VIEW는 제한적인 자료를 보기위해 사용하는 가상테이블입니다.
VIEW를 이용해서 필요한 컬럼을 정의해두면, 관리가 용이해집니다.
...
------------------------------------------------------------------
/*
VIEW를 통한 DML은 가능하긴하지만, 몇가지 제약사항이 있습니다.
...
--1. 가상열이면 안됩니다. (NAME칼럼은 VIEW 테이블이 없기때문)
